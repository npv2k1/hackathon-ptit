    ...
    return (
      <div className={className}>
        {label && (
          <label
            htmlFor={name}
            className="block text-body-dark font-semibold text-sm leading-none mb-3 float-left"
          >
            {label}
          </label>
        )}
        <input
          ...
          ref={ref}
          className={cn(
            'px-4 py-3 flex items-center w-full appearance-none transition duration-300 ease-in-out text-sm focus:outline-none focus:ring-0',
            shadow && 'focus:shadow',
